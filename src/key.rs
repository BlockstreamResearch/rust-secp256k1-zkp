...
/// ```
/// # #[cfg(feature =  "alloc")] {
/// use secp256k1_zkp::{SecretKey, Secp256k1, PublicKey};
///
/// let secp = Secp256k1::new();
...
impl SecretKey {
    ...
    /// use secp256k1_zkp::{rand, SecretKey};
    /// let secret_key = SecretKey::new(&mut rand::rng());
    /// # }
    /// ```
    #[inline]
    ...
    /// ```
    /// # #[cfg(all(feature = "rand", feature = "std"))] {
    /// use secp256k1_zkp::{rand, Secp256k1, SecretKey, Keypair};
    ///
    /// let secp = Secp256k1::new();
...
impl PublicKey {
    ...
    /// ```
    /// # #[cfg(all(feature = "rand", feature = "std"))] {
    /// use secp256k1_zkp::{rand, Secp256k1, SecretKey, PublicKey};
    ///
    /// let secp = Secp256k1::new();
    /// let secret_key = SecretKey::new(&mut rand::rng());
    /// let public_key = PublicKey::from_secret_key(&secp, &secret_key);
    ...
    /// ```
    /// # #[cfg(all(feature = "rand", feature = "std"))] {
    /// use secp256k1_zkp::{rand, Secp256k1, PublicKey, Keypair};
    ///
    /// let secp = Secp256k1::new();
    /// let keypair = Keypair::new(&secp, &mut rand::rng());
    ...
    /// ```
    /// # #[cfg(all(feature = "rand", feature = "std"))] {
    /// use secp256k1_zkp::{rand, Secp256k1, PublicKey};
    ///
    /// let secp = Secp256k1::new();
    /// let mut rng = rand::rng();
    /// let (_, pk1) = secp.generate_keypair(&mut rng);
...
/// ```
/// # #[cfg(all(feature = "rand", feature = "std"))] {
/// use secp256k1_zkp::{rand, Secp256k1, Keypair, XOnlyPublicKey};
///
/// let secp = Secp256k1::new();
/// let keypair = Keypair::new(&secp, &mut rand::rng());
