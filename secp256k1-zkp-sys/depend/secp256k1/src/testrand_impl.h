...
static rustsecp256k1zkp_v0_6_0_rfc6979_hmac_sha256 rustsecp256k1zkp_v0_6_0_test_rng;
static uint32_t rustsecp256k1zkp_v0_6_0_test_rng_precomputed[8];
static int rustsecp256k1zkp_v0_6_0_test_rng_precomputed_used = 8;
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_6_0_testrand_seed(const unsigned char *seed16) {
    rustsecp256k1zkp_v0_6_0_rfc6979_hmac_sha256_initialize(&rustsecp256k1zkp_v0_6_0_test_rng, seed16, 16);
}

SECP256K1_INLINE static uint32_t rustsecp256k1zkp_v0_6_0_testrand32(void) {
    if (rustsecp256k1zkp_v0_6_0_test_rng_precomputed_used == 8) {
        rustsecp256k1zkp_v0_6_0_rfc6979_hmac_sha256_generate(&rustsecp256k1zkp_v0_6_0_test_rng, (unsigned char*)(&rustsecp256k1zkp_v0_6_0_test_rng_precomputed[0]), sizeof(rustsecp256k1zkp_v0_6_0_test_rng_precomputed));
        rustsecp256k1zkp_v0_6_0_test_rng_precomputed_used = 0;
    }
    return rustsecp256k1zkp_v0_6_0_test_rng_precomputed[rustsecp256k1zkp_v0_6_0_test_rng_precomputed_used++];
}

static uint32_t rustsecp256k1zkp_v0_6_0_testrand_bits(int bits) {
    uint32_t ret;
    if (rustsecp256k1zkp_v0_6_0_test_rng_integer_bits_left < bits) {
        rustsecp256k1zkp_v0_6_0_test_rng_integer |= (((uint64_t)rustsecp256k1zkp_v0_6_0_testrand32()) << rustsecp256k1zkp_v0_6_0_test_rng_integer_bits_left);
        rustsecp256k1zkp_v0_6_0_test_rng_integer_bits_left += 32;
    }
...
static void rustsecp256k1zkp_v0_6_0_testrand256(unsigned char *b32) {
    rustsecp256k1zkp_v0_6_0_rfc6979_hmac_sha256_generate(&rustsecp256k1zkp_v0_6_0_test_rng, b32, 32);
}
...
static void rustsecp256k1zkp_v0_6_0_testrand_flip(unsigned char *b, size_t len) {
    b[rustsecp256k1zkp_v0_6_0_testrand_int(len)] ^= (1 << rustsecp256k1zkp_v0_6_0_testrand_int(8));
}
