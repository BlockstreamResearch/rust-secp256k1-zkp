...
int main(int argc, char **argv) {
    rustsecp256k1zkp_v0_4_0_ecmult_gen_context ctx;
    void *prealloc, *base;
    int inner;
    int outer;
    FILE* fp;
    ...
    fprintf(fp, "#endif\n");
    fprintf(fp, "static const rustsecp256k1zkp_v0_4_0_ge_storage rustsecp256k1zkp_v0_4_0_ecmult_static_context[ECMULT_GEN_PREC_N][ECMULT_GEN_PREC_G] = {\n");

    base = checked_malloc(&default_error_callback, SECP256K1_ECMULT_GEN_CONTEXT_PREALLOCATED_SIZE);
    prealloc = base;
    rustsecp256k1zkp_v0_4_0_ecmult_gen_context_init(&ctx);
    rustsecp256k1zkp_v0_4_0_ecmult_gen_context_build(&ctx, &prealloc);
    ...
    fprintf(fp,"};\n");
    rustsecp256k1zkp_v0_4_0_ecmult_gen_context_clear(&ctx);
    free(base);
