...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_5_0_scalar_clear(rustsecp256k1zkp_v0_5_0_scalar *r) { *r = 0; }
SECP256K1_INLINE static void rustsecp256k1zkp_v0_5_0_scalar_set_int(rustsecp256k1zkp_v0_5_0_scalar *r, unsigned int v) { *r = v; }
SECP256K1_INLINE static void rustsecp256k1zkp_v0_5_0_scalar_set_u64(rustsecp256k1zkp_v0_5_0_scalar *r, uint64_t v) { *r = v % EXHAUSTIVE_TEST_ORDER; }
...
SECP256K1_INLINE static int rustsecp256k1zkp_v0_5_0_scalar_check_overflow(const rustsecp256k1zkp_v0_5_0_scalar *a) { return *a >= EXHAUSTIVE_TEST_ORDER; }
...
static int rustsecp256k1zkp_v0_5_0_scalar_cond_negate(rustsecp256k1zkp_v0_5_0_scalar *r, int flag) {
    if (flag) rustsecp256k1zkp_v0_5_0_scalar_negate(r, r);
    return flag ? -1 : 1;
}
...
static void rustsecp256k1zkp_v0_5_0_scalar_split_128(rustsecp256k1zkp_v0_5_0_scalar *r1, rustsecp256k1zkp_v0_5_0_scalar *r2, const rustsecp256k1zkp_v0_5_0_scalar *a) {
    *r1 = *a;
    *r2 = 0;
}
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_5_0_scalar_chacha20(rustsecp256k1zkp_v0_5_0_scalar *r1, rustsecp256k1zkp_v0_5_0_scalar *r2, const unsigned char *seed, uint64_t n) {
