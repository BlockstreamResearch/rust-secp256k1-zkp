...
typedef struct {
    ...
    const rustsecp256k1zkp_v0_4_0_keypair **keypairs;
...
int main(void) {
    ...
    data.ctx = rustsecp256k1zkp_v0_4_0_context_create(SECP256K1_CONTEXT_VERIFY | SECP256K1_CONTEXT_SIGN);
    data.keypairs = (const rustsecp256k1zkp_v0_4_0_keypair **)malloc(iters * sizeof(rustsecp256k1zkp_v0_4_0_keypair *));
