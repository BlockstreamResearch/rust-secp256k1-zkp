...
static void rustsecp256k1zkp_v0_4_0_fe_normalize(rustsecp256k1zkp_v0_4_0_fe *r) {
...
static void rustsecp256k1zkp_v0_4_0_fe_normalize_weak(rustsecp256k1zkp_v0_4_0_fe *r) {
    uint32_t t0 = r->n[0], t1 = r->n[1], t2 = r->n[2], t3 = r->n[3], t4 = r->n[4],
             t5 = r->n[5], t6 = r->n[6], t7 = r->n[7], t8 = r->n[8], t9 = r->n[9];
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_set_int(rustsecp256k1zkp_v0_4_0_fe *r, int a) {
    r->n[0] = a;
...
SECP256K1_INLINE static int rustsecp256k1zkp_v0_4_0_fe_is_zero(const rustsecp256k1zkp_v0_4_0_fe *a) {
    const uint32_t *t = a->n;
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    rustsecp256k1zkp_v0_4_0_fe_verify(a);
#endif
    return (t[0] | t[1] | t[2] | t[3] | t[4] | t[5] | t[6] | t[7] | t[8] | t[9]) == 0;
}

SECP256K1_INLINE static int rustsecp256k1zkp_v0_4_0_fe_is_odd(const rustsecp256k1zkp_v0_4_0_fe *a) {
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    rustsecp256k1zkp_v0_4_0_fe_verify(a);
#endif
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_clear(rustsecp256k1zkp_v0_4_0_fe *a) {
    int i;
#ifdef VERIFY
    a->magnitude = 0;
    a->normalized = 1;
...
static int rustsecp256k1zkp_v0_4_0_fe_cmp_var(const rustsecp256k1zkp_v0_4_0_fe *a, const rustsecp256k1zkp_v0_4_0_fe *b) {
    int i;
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    VERIFY_CHECK(b->normalized);
    rustsecp256k1zkp_v0_4_0_fe_verify(a);
    rustsecp256k1zkp_v0_4_0_fe_verify(b);
#endif
    for (i = 9; i >= 0; i--) {
        if (a->n[i] > b->n[i]) {
            return 1;
...
static int rustsecp256k1zkp_v0_4_0_fe_set_b32(rustsecp256k1zkp_v0_4_0_fe *r, const unsigned char *a) {
    int ret;
...
static void rustsecp256k1zkp_v0_4_0_fe_get_b32(unsigned char *r, const rustsecp256k1zkp_v0_4_0_fe *a) {
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
    rustsecp256k1zkp_v0_4_0_fe_verify(a);
#endif
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_negate(rustsecp256k1zkp_v0_4_0_fe *r, const rustsecp256k1zkp_v0_4_0_fe *a, int m) {
#ifdef VERIFY
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_mul_int(rustsecp256k1zkp_v0_4_0_fe *r, int a) {
    r->n[0] *= a;
    r->n[1] *= a;
    r->n[2] *= a;
    r->n[3] *= a;
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_add(rustsecp256k1zkp_v0_4_0_fe *r, const rustsecp256k1zkp_v0_4_0_fe *a) {
#ifdef VERIFY
    rustsecp256k1zkp_v0_4_0_fe_verify(a);
#endif
    r->n[0] += a->n[0];
...
void rustsecp256k1zkp_v0_4_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b);
void rustsecp256k1zkp_v0_4_0_fe_sqr_inner(uint32_t *r, const uint32_t *a);
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_mul_inner(uint32_t *r, const uint32_t *a, const uint32_t * SECP256K1_RESTRICT b) {
    uint64_t c, d;
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_4_0_fe_sqr_inner(uint32_t *r, const uint32_t *a) {
    uint64_t c, d;
    uint64_t u0, u1, u2, u3, u4, u5, u6, u7, u8;
...
static void rustsecp256k1zkp_v0_4_0_fe_mul(rustsecp256k1zkp_v0_4_0_fe *r, const rustsecp256k1zkp_v0_4_0_fe *a, const rustsecp256k1zkp_v0_4_0_fe * SECP256K1_RESTRICT b) {
#ifdef VERIFY
    ...
    VERIFY_CHECK(a != b);
#endif
    rustsecp256k1zkp_v0_4_0_fe_mul_inner(r->n, a->n, b->n);
#ifdef VERIFY
    r->magnitude = 1;
    r->normalized = 0;
    rustsecp256k1zkp_v0_4_0_fe_verify(r);
...
static void rustsecp256k1zkp_v0_4_0_fe_sqr(rustsecp256k1zkp_v0_4_0_fe *r, const rustsecp256k1zkp_v0_4_0_fe *a) {
#ifdef VERIFY
    VERIFY_CHECK(a->magnitude <= 8);
    rustsecp256k1zkp_v0_4_0_fe_verify(a);
#endif
    rustsecp256k1zkp_v0_4_0_fe_sqr_inner(r->n, a->n);
#ifdef VERIFY
    r->magnitude = 1;
    r->normalized = 0;
    rustsecp256k1zkp_v0_4_0_fe_verify(r);
...
static SECP256K1_INLINE void rustsecp256k1zkp_v0_4_0_fe_cmov(rustsecp256k1zkp_v0_4_0_fe *r, const rustsecp256k1zkp_v0_4_0_fe *a, int flag) {
...
static SECP256K1_INLINE void rustsecp256k1zkp_v0_4_0_fe_storage_cmov(rustsecp256k1zkp_v0_4_0_fe_storage *r, const rustsecp256k1zkp_v0_4_0_fe_storage *a, int flag) {
    uint32_t mask0, mask1;
    VG_CHECK_VERIFY(r->n, sizeof(r->n));
    mask0 = flag + ~((uint32_t)0);
    mask1 = ~mask0;
...
static void rustsecp256k1zkp_v0_4_0_fe_to_storage(rustsecp256k1zkp_v0_4_0_fe_storage *r, const rustsecp256k1zkp_v0_4_0_fe *a) {
#ifdef VERIFY
    VERIFY_CHECK(a->normalized);
#endif
...
static SECP256K1_INLINE void rustsecp256k1zkp_v0_4_0_fe_from_storage(rustsecp256k1zkp_v0_4_0_fe *r, const rustsecp256k1zkp_v0_4_0_fe_storage *a) {
