...
static void rustsecp256k1zkp_v0_11_0_pedersen_scalar_set_u64(rustsecp256k1zkp_v0_11_0_scalar *sec, uint64_t value) {
    ...
    rustsecp256k1zkp_v0_11_0_scalar_set_b32(sec, data, NULL);
    rustsecp256k1zkp_v0_11_0_memclear_explicit(data, 32);
}

static void rustsecp256k1zkp_v0_11_0_pedersen_ecmult_small(rustsecp256k1zkp_v0_11_0_gej *r, uint64_t gn, const rustsecp256k1zkp_v0_11_0_ge* genp) {
    rustsecp256k1zkp_v0_11_0_scalar s;
    rustsecp256k1zkp_v0_11_0_pedersen_scalar_set_u64(&s, gn);
    rustsecp256k1zkp_v0_11_0_ecmult_const(r, genp, &s);
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_11_0_pedersen_ecmult(const rustsecp256k1zkp_v0_11_0_ecmult_gen_context *ecmult_gen_ctx, rustsecp256k1zkp_v0_11_0_gej *rj, const rustsecp256k1zkp_v0_11_0_scalar *sec, uint64_t value, const rustsecp256k1zkp_v0_11_0_ge* genp) {
    ...
    rustsecp256k1zkp_v0_11_0_gej_clear(&vj);
}
