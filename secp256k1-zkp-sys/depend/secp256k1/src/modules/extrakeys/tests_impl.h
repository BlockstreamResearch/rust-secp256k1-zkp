...
void test_xonly_pubkey_tweak(void) {
    ...
    ecount = 0;
    CHECK(rustsecp256k1zkp_v0_6_0_xonly_pubkey_tweak_add(none, &output_pk, &internal_xonly_pk, tweak) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_6_0_xonly_pubkey_tweak_add(sign, &output_pk, &internal_xonly_pk, tweak) == 0);
    CHECK(ecount == 2);
...
void test_xonly_pubkey_tweak_check(void) {
    ...
    CHECK(rustsecp256k1zkp_v0_6_0_xonly_pubkey_tweak_add_check(none, buf32, pk_parity, &internal_xonly_pk, tweak) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_6_0_xonly_pubkey_tweak_add_check(sign, buf32, pk_parity, &internal_xonly_pk, tweak) == 0);
    CHECK(ecount == 2);
...
void test_keypair(void) {
    ...
    ecount = 0;
    rustsecp256k1zkp_v0_6_0_testrand256(sk);
    CHECK(rustsecp256k1zkp_v0_6_0_keypair_create(none, &keypair, sk) == 0);
    CHECK(rustsecp256k1zkp_v0_6_0_memcmp_var(zeros96, &keypair, sizeof(keypair)) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_6_0_keypair_create(verify, &keypair, sk) == 0);
    CHECK(rustsecp256k1zkp_v0_6_0_memcmp_var(zeros96, &keypair, sizeof(keypair)) == 0);
    CHECK(ecount == 2);
...
void test_keypair_add(void) {
    ...
    CHECK(rustsecp256k1zkp_v0_6_0_keypair_xonly_tweak_add(none, &keypair, tweak) == 0);
    CHECK(ecount == 1);
    CHECK(rustsecp256k1zkp_v0_6_0_keypair_xonly_tweak_add(sign, &keypair, tweak) == 0);
    CHECK(ecount == 2);
