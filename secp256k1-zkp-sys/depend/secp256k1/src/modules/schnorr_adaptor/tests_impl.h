...
static void run_nonce_function_schnorr_adaptor_tests(void) {
     ...
     * rustsecp256k1zkp_v0_10_1_nonce_function_schnorr_adaptor_sha256_tagged has the expected
     * state. */
    rustsecp256k1zkp_v0_10_1_sha256_initialize_tagged(&sha, tag, sizeof(tag));
    rustsecp256k1zkp_v0_10_1_nonce_function_schnorr_adaptor_sha256_tagged(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);

   /* Check that hash initialized by
    * rustsecp256k1zkp_v0_10_1_nonce_function_schnorr_adaptor_sha256_tagged_aux has the expected
    * state. */
    rustsecp256k1zkp_v0_10_1_sha256_initialize_tagged(&sha, aux_tag, sizeof(aux_tag));
    rustsecp256k1zkp_v0_10_1_nonce_function_schnorr_adaptor_sha256_tagged_aux(&sha_optimized);
    test_sha256_eq(&sha, &sha_optimized);
     ...
     * is acceptable. */
    rustsecp256k1zkp_v0_10_1_testrand_bytes_test(adaptor, sizeof(adaptor));
    rustsecp256k1zkp_v0_10_1_testrand256(pk);
    rustsecp256k1zkp_v0_10_1_testrand256(aux_rand);
    ...
    /* Other algo is fine */
    rustsecp256k1zkp_v0_10_1_testrand_bytes_test(algo, algolen);
    CHECK(nonce_function_schnorr_adaptor(nonce, msg, key, adaptor, pk, algo, algolen, NULL) == 1);
    ...
    CHECK(nonce_function_schnorr_adaptor(nonce, msg, key, adaptor, pk, algo, algolen, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(nonce_z, nonce, 32) == 0);
}
...
static void test_schnorr_adaptor_api(void) {
    ...
    rustsecp256k1zkp_v0_10_1_keypair invalid_keypair = {{ 0 }};
    rustsecp256k1zkp_v0_10_1_xonly_pubkey pk;
    rustsecp256k1zkp_v0_10_1_xonly_pubkey zero_pk;
    unsigned char pre_sig[65];
    unsigned char invalid_pre_sig[65] = { 0 };
    unsigned char sig[64];
    unsigned char sec_adaptor[32];
    rustsecp256k1zkp_v0_10_1_pubkey adaptor;
    rustsecp256k1zkp_v0_10_1_pubkey invalid_adaptor = {{ 0 }};
    unsigned char extracted_sec_adaptor[32];
    rustsecp256k1zkp_v0_10_1_pubkey extracted_adaptor;
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_keypair_xonly_pub(CTX, &pk, NULL, &keypair) == 1);
    memset(&zero_pk, 0, sizeof(zero_pk));
    CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_create(CTX, &adaptor, sec_adaptor) == 1);

    /* main test body */
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, &adaptor, NULL) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, NULL, msg, &keypair, &adaptor, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, NULL, &keypair, &adaptor, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, NULL, &adaptor, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, NULL, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &invalid_keypair, &adaptor, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, &invalid_adaptor, NULL));
    CHECK_ILLEGAL(STATIC_CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(STATIC_CTX, pre_sig, msg, &keypair, &adaptor, NULL));

    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, &adaptor, NULL) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, pre_sig, msg, &pk) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(&extracted_adaptor, &adaptor, sizeof(adaptor)) == 0);
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, NULL, pre_sig, msg, &pk));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, NULL, msg, &pk));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, pre_sig, NULL, &pk));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, pre_sig, msg, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, pre_sig, msg, &zero_pk));

    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, sec_adaptor) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, NULL, pre_sig, sec_adaptor));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, NULL, sec_adaptor));
    /* invalid pre_sig[0] byte */
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, invalid_pre_sig, sec_adaptor) == 0);
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, NULL));

    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, sec_adaptor) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor, pre_sig, sig) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, NULL, pre_sig, sig));
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor, NULL, sig));
    /* invalid pre_sig[0] byte */
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor, invalid_pre_sig, sig) == 0);
    CHECK_ILLEGAL(CTX, rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor, pre_sig, NULL));
}
...
static void test_schnorr_adaptor_spec_vectors_check_presigning(const unsigned char *sk, const unsigned char *pk_serialized, const unsigned char *aux_rand, const unsigned char *msg32, const unsigned char *adaptor_serialized, const unsigned char *expected_presig) {
    unsigned char pre_sig[65];
    rustsecp256k1zkp_v0_10_1_keypair keypair;
    rustsecp256k1zkp_v0_10_1_xonly_pubkey pk, pk_expected;
    rustsecp256k1zkp_v0_10_1_pubkey adaptor, adaptor_extracted;
    CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_parse(CTX, &adaptor, adaptor_serialized, 33));

    CHECK(rustsecp256k1zkp_v0_10_1_keypair_create(CTX, &keypair, sk));
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg32, &keypair, &adaptor, aux_rand));
    CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(pre_sig, expected_presig, 65) == 0);

    CHECK(rustsecp256k1zkp_v0_10_1_xonly_pubkey_parse(CTX, &pk_expected, pk_serialized));
    CHECK(rustsecp256k1zkp_v0_10_1_keypair_xonly_pub(CTX, &pk, NULL, &keypair));
    CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(&pk, &pk_expected, sizeof(pk)) == 0);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &adaptor_extracted, pre_sig, msg32, &pk));
    CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &adaptor_extracted, &adaptor) == 0);
}
...
static void test_schnorr_adaptor_spec_vectors_check_extract(const unsigned char *pk_serialized, const unsigned char *msg32, const unsigned char *adaptor_serialized, const unsigned char *pre_sig, int extract_success, int extracted_val_correct) {
    rustsecp256k1zkp_v0_10_1_xonly_pubkey pk;
    rustsecp256k1zkp_v0_10_1_pubkey adaptor, adaptor_extracted;
    CHECK(rustsecp256k1zkp_v0_10_1_xonly_pubkey_parse(CTX, &pk, pk_serialized));
    CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_parse(CTX, &adaptor, adaptor_serialized, 33));
    CHECK(extract_success == rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &adaptor_extracted, pre_sig, msg32, &pk));
    if (extract_success) {
        CHECK(extracted_val_correct == (rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &adaptor_extracted, &adaptor) == 0));
    }
 }
...
static void test_schnorr_adaptor_spec_vectors_check_adapt(const unsigned char *pk_serialized, const unsigned char *msg32, const unsigned char *pre_sig, const unsigned char *secadaptor, const unsigned char *expected_sig, int expected) {
    unsigned char sig[64];
    rustsecp256k1zkp_v0_10_1_xonly_pubkey pk;
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, secadaptor));
    CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(sig, expected_sig, 64) == 0);

    CHECK(rustsecp256k1zkp_v0_10_1_xonly_pubkey_parse(CTX, &pk, pk_serialized));
    CHECK(expected == rustsecp256k1zkp_v0_10_1_schnorrsig_verify(CTX, sig, msg32, 32, &pk));
}
...
static void test_schnorr_adaptor_spec_vectors_check_extract_sec(const unsigned char *pre_sig, const unsigned char *sig, const unsigned char *expected_secadaptor, int expected) {
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, sec_adaptor, pre_sig, sig));
    CHECK(expected == (rustsecp256k1zkp_v0_10_1_memcmp_var(sec_adaptor, expected_secadaptor, 32) == 0));
}
...
static void test_schnorr_adaptor_spec_vectors(void) {
    ...
    };
    {
        ...
        rustsecp256k1zkp_v0_10_1_xonly_pubkey pk_parsed;
        /* No need to check adaptor_extract as parsing the pubkey already fails */
        CHECK(!rustsecp256k1zkp_v0_10_1_xonly_pubkey_parse(CTX, &pk_parsed, pk));
    };
    {
    ...
    };
    {
        ...
        rustsecp256k1zkp_v0_10_1_pubkey adaptor_parsed;
        /* No need to check adaptor_extract as parsing the adaptor point already fails */
        CHECK(!rustsecp256k1zkp_v0_10_1_ec_pubkey_parse(CTX, &adaptor_parsed, adaptor, sizeof(adaptor)));
    };
    {
        /* Adapt: Test vector 0 */
        const unsigned char pk[32] = {
...
static void test_schnorr_adaptor_edge_cases(void) {
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, &adaptor, aux_rand) == 1);
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, &adaptor, aux_rand) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, pre_sig, msg, &pk) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &extracted_adaptor, &adaptor) == 0);
    {
        /* invalid R' (= pre_sig[0:33]) */
        unsigned char pre_sig_tmp[65];
        rustsecp256k1zkp_v0_10_1_pubkey extracted_adaptor_tmp;
        memcpy(pre_sig_tmp, pre_sig, sizeof(pre_sig_tmp));
        memset(pre_sig_tmp, 0xFF, 33);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor_tmp, pre_sig_tmp, msg, &pk) == 0);
    }
    {
        /* overflowing s */
        unsigned char pre_sig_tmp[65];
    ...
    }
    {
        ...
        rustsecp256k1zkp_v0_10_1_pubkey extracted_adaptor_tmp;
        memcpy(pre_sig_tmp, pre_sig, sizeof(pre_sig_tmp));
        rustsecp256k1zkp_v0_10_1_scalar_set_b32(&s, &pre_sig_tmp[33], NULL);
        rustsecp256k1zkp_v0_10_1_scalar_negate(&s, &s);
        rustsecp256k1zkp_v0_10_1_scalar_get_b32(&pre_sig_tmp[33], &s);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor_tmp, pre_sig_tmp, msg, &pk) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &extracted_adaptor_tmp, &adaptor) != 0);
    }
    {
        ...
        if(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor_tmp, pre_sig_tmp, msg, &pk)) {
            CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &extracted_adaptor_tmp, &adaptor) != 0);
        }
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor_tmp, pre_sig, msg_tmp, &pk) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &extracted_adaptor_tmp, &adaptor) != 0);
    }
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &keypair, &adaptor, aux_rand) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, sec_adaptor) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk) == 1);
    {
        /* overflowing sec_adaptor */
        unsigned char sig_tmp[64];
        unsigned char sec_adaptor_tmp[32];
        memset(sec_adaptor_tmp, 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig_tmp, pre_sig, sec_adaptor_tmp) == 0);
    }
    {
        /* overflowing s */
        unsigned char sig_tmp[64];
        ...
        memcpy(pre_sig_tmp, pre_sig, sizeof(pre_sig_tmp));
        memset(&pre_sig_tmp[33], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig_tmp, pre_sig_tmp, sec_adaptor) == 0);
    }
    {
        /* negated s */
        unsigned char sig_tmp[64];
        ...
        rustsecp256k1zkp_v0_10_1_scalar_negate(&s, &s);
        rustsecp256k1zkp_v0_10_1_scalar_get_b32(&pre_sig_tmp[33], &s);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig_tmp, pre_sig_tmp, sec_adaptor) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorrsig_verify(CTX, sig_tmp, msg, sizeof(msg), &pk) == 0);
    }
    {
        ...
        if (rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig_tmp, pre_sig_tmp, sec_adaptor)) {
            CHECK(rustsecp256k1zkp_v0_10_1_schnorrsig_verify(CTX, sig_tmp, msg, sizeof(msg), &pk) == 0);
        }
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig_tmp, pre_sig, sec_adaptor_tmp) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorrsig_verify(CTX, sig_tmp, msg, sizeof(msg), &pk) == 0);
    }
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, sec_adaptor) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor, pre_sig, sig) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(extracted_sec_adaptor, sec_adaptor, sizeof(extracted_sec_adaptor)) == 0);
    {
        ...
        memcpy(pre_sig_tmp, pre_sig, sizeof(pre_sig_tmp));
        memset(&pre_sig_tmp[33], 0xFF, 32);
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor_tmp, pre_sig_tmp, sig) == 0);
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor_tmp, pre_sig, sig_tmp) == 0);
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor_tmp, pre_sig_tmp, sig) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(extracted_sec_adaptor_tmp, sec_adaptor, sizeof(extracted_sec_adaptor_tmp)) != 0);
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor_tmp, pre_sig, sig_tmp) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(extracted_sec_adaptor_tmp, sec_adaptor, sizeof(extracted_sec_adaptor_tmp)) != 0);
    }
    {
        ...
        CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(CTX, extracted_sec_adaptor_tmp, pre_sig_tmp, sig_tmp) == 1);
        CHECK(rustsecp256k1zkp_v0_10_1_memcmp_var(extracted_sec_adaptor_tmp, sec_adaptor, sizeof(extracted_sec_adaptor_tmp)) == 0);
    }
}
...
static void test_schnorr_adaptor_correctness(void) {
    ...
    rustsecp256k1zkp_v0_10_1_keypair alice_keypair;
    ...
    /* Alice setup */
    rustsecp256k1zkp_v0_10_1_testrand256(alice_sk);
    CHECK(rustsecp256k1zkp_v0_10_1_keypair_create(CTX, &alice_keypair, alice_sk) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_keypair_xonly_pub(CTX, &alice_pk, NULL, &alice_keypair) == 1);
     ...
     * and sends it to Bob. */
    rustsecp256k1zkp_v0_10_1_testrand256(msg);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(CTX, pre_sig, msg, &alice_keypair, &adaptor, NULL) == 1);

    /* Bob extracts the adaptor point from the pre-signature,
     * and verifies if it is equal to T */
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(CTX, &extracted_adaptor, pre_sig, msg, &alice_pk) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_ec_pubkey_cmp(CTX, &extracted_adaptor, &adaptor) == 0);
    ...
    CHECK(rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(CTX, sig, pre_sig, sec_adaptor) == 1);
    CHECK(rustsecp256k1zkp_v0_10_1_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &alice_pk) == 1);
