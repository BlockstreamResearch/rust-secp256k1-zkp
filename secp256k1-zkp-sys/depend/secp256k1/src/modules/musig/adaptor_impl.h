...
int rustsecp256k1zkp_v0_10_0_musig_nonce_parity(const rustsecp256k1zkp_v0_10_0_context* ctx, int *nonce_parity, const rustsecp256k1zkp_v0_10_0_musig_session *session) {
...
int rustsecp256k1zkp_v0_10_0_musig_adapt(const rustsecp256k1zkp_v0_10_0_context* ctx, unsigned char *sig64, const unsigned char *pre_sig64, const unsigned char *sec_adaptor32, int nonce_parity) {
...
int rustsecp256k1zkp_v0_10_0_musig_extract_adaptor(const rustsecp256k1zkp_v0_10_0_context* ctx, unsigned char *sec_adaptor32, const unsigned char *sig64, const unsigned char *pre_sig64, int nonce_parity) {
    rustsecp256k1zkp_v0_10_0_scalar t;
    rustsecp256k1zkp_v0_10_0_scalar s;
    int overflow;
    int ret = 1;
