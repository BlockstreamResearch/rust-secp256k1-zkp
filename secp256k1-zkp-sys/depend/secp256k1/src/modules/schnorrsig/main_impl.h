...
static void rustsecp256k1zkp_v0_4_0_nonce_function_bip340_sha256_tagged(rustsecp256k1zkp_v0_4_0_sha256 *sha) {
...
static void rustsecp256k1zkp_v0_4_0_nonce_function_bip340_sha256_tagged_aux(rustsecp256k1zkp_v0_4_0_sha256 *sha) {
    rustsecp256k1zkp_v0_4_0_sha256_initialize(sha);
...
static int nonce_function_bip340(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *xonly_pk32, const unsigned char *algo16, void *data) {
    ...
    if (data != NULL) {
        rustsecp256k1zkp_v0_4_0_nonce_function_bip340_sha256_tagged_aux(&sha);
...
const rustsecp256k1zkp_v0_4_0_nonce_function_hardened rustsecp256k1zkp_v0_4_0_nonce_function_bip340 = nonce_function_bip340;

/* Initializes SHA256 with fixed midstate. This midstate was computed by applying
 * SHA256 to SHA256("BIP0340/challenge")||SHA256("BIP0340/challenge"). */
static void rustsecp256k1zkp_v0_4_0_schnorrsig_sha256_tagged(rustsecp256k1zkp_v0_4_0_sha256 *sha) {
    rustsecp256k1zkp_v0_4_0_sha256_initialize(sha);
...
int rustsecp256k1zkp_v0_4_0_schnorrsig_sign(const rustsecp256k1zkp_v0_4_0_context* ctx, unsigned char *sig64, const unsigned char *msg32, const rustsecp256k1zkp_v0_4_0_keypair *keypair, rustsecp256k1zkp_v0_4_0_nonce_function_hardened noncefp, void *ndata) {
    ...
    if (noncefp == NULL) {
        noncefp = rustsecp256k1zkp_v0_4_0_nonce_function_bip340;
    }
    ...
    rustsecp256k1zkp_v0_4_0_memczero(sig64, 64, !ret);
...
int rustsecp256k1zkp_v0_4_0_schnorrsig_verify(const rustsecp256k1zkp_v0_4_0_context* ctx, const unsigned char *sig64, const unsigned char *msg32, const rustsecp256k1zkp_v0_4_0_xonly_pubkey *pubkey) {
    ...
    rustsecp256k1zkp_v0_4_0_gej_set_ge(&pkj, &pk);
    rustsecp256k1zkp_v0_4_0_ecmult(&ctx->ecmult_ctx, &rj, &pkj, &e, &s);

    rustsecp256k1zkp_v0_4_0_ge_set_gej_var(&r, &rj);
    if (rustsecp256k1zkp_v0_4_0_ge_is_infinity(&r)) {
        return 0;
    }

    rustsecp256k1zkp_v0_4_0_fe_normalize_var(&r.y);
    return !rustsecp256k1zkp_v0_4_0_fe_is_odd(&r.y) &&
           rustsecp256k1zkp_v0_4_0_fe_equal_var(&rx, &r.x);
}
