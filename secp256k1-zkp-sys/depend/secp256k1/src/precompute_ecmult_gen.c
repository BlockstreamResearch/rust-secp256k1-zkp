...
int main(int argc, char **argv) {
    ...
    for (bits = 2; bits <= 8; bits *= 2) {
        ...
        rustsecp256k1zkp_v0_10_0_ge_storage* table = checked_malloc(&default_error_callback, n * g * sizeof(rustsecp256k1zkp_v0_10_0_ge_storage));
        rustsecp256k1zkp_v0_10_0_ecmult_gen_compute_table(table, &rustsecp256k1zkp_v0_10_0_ge_const_g, bits);
