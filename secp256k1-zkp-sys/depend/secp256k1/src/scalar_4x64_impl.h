...
SECP256K1_INLINE static int rustsecp256k1zkp_v0_5_0_scalar_reduce(rustsecp256k1zkp_v0_5_0_scalar *r, unsigned int overflow) {
    uint128_t t;
...
static void rustsecp256k1zkp_v0_5_0_scalar_negate(rustsecp256k1zkp_v0_5_0_scalar *r, const rustsecp256k1zkp_v0_5_0_scalar *a) {
    uint64_t nonzero = 0xFFFFFFFFFFFFFFFFULL * (rustsecp256k1zkp_v0_5_0_scalar_is_zero(a) == 0);
...
static int rustsecp256k1zkp_v0_5_0_scalar_cond_negate(rustsecp256k1zkp_v0_5_0_scalar *r, int flag) {
    ...
    uint64_t nonzero = (rustsecp256k1zkp_v0_5_0_scalar_is_zero(r) != 0) - 1;
...
static void rustsecp256k1zkp_v0_5_0_scalar_reduce_512(rustsecp256k1zkp_v0_5_0_scalar *r, const uint64_t *l) {
...
static void rustsecp256k1zkp_v0_5_0_scalar_mul_512(uint64_t l[8], const rustsecp256k1zkp_v0_5_0_scalar *a, const rustsecp256k1zkp_v0_5_0_scalar *b) {
#ifdef USE_ASM_X86_64
...
static void rustsecp256k1zkp_v0_5_0_scalar_sqr_512(uint64_t l[8], const rustsecp256k1zkp_v0_5_0_scalar *a) {
#ifdef USE_ASM_X86_64
    __asm__ __volatile__(
    /* Preload */
    "movq 0(%%rdi), %%r11\n"
...
SECP256K1_INLINE static void rustsecp256k1zkp_v0_5_0_scalar_mul_shift_var(rustsecp256k1zkp_v0_5_0_scalar *r, const rustsecp256k1zkp_v0_5_0_scalar *a, const rustsecp256k1zkp_v0_5_0_scalar *b, unsigned int shift) {
    ...
    rustsecp256k1zkp_v0_5_0_scalar_cadd_bit(r, 0, (l[(shift - 1) >> 6] >> ((shift - 1) & 0x3f)) & 1);
}
