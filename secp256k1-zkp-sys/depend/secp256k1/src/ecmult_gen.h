...
typedef struct {
     ...
     */
    rustsecp256k1zkp_v0_4_0_ge_storage (*prec)[ECMULT_GEN_PREC_N][ECMULT_GEN_PREC_G]; /* prec[j][i] = (PREC_G)^j * i * G + U_i */
...
static void rustsecp256k1zkp_v0_4_0_ecmult_gen(const rustsecp256k1zkp_v0_4_0_ecmult_gen_context* ctx, rustsecp256k1zkp_v0_4_0_gej *r, const rustsecp256k1zkp_v0_4_0_scalar *a);
