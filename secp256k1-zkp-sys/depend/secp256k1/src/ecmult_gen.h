 ...
 * rustsecp256k1zkp_v0_11_0_ge_storages.
 *
 ...
 * the table cannot have infinities in them (rustsecp256k1zkp_v0_11_0_ge_storage
...
typedef struct {
    ...
    rustsecp256k1zkp_v0_11_0_scalar scalar_offset;
    rustsecp256k1zkp_v0_11_0_ge ge_offset;

    /* Factor used for projective blinding. This value is used to rescale the Z
     * coordinate of the first table lookup. */
    rustsecp256k1zkp_v0_11_0_fe proj_blind;
} rustsecp256k1zkp_v0_11_0_ecmult_gen_context;
