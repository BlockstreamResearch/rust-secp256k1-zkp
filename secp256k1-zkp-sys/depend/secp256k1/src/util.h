...
static SECP256K1_INLINE void rustsecp256k1zkp_v0_3_0_callback_call(const rustsecp256k1zkp_v0_3_0_callback * const cb, const char * const text) {
...
SECP256K1_INLINE static int rustsecp256k1zkp_v0_3_0_sign_and_abs64(uint64_t *out, int64_t in) {
...
SECP256K1_INLINE static int rustsecp256k1zkp_v0_3_0_clz64_var(uint64_t x) {
    int ret;
    if (!x) {
        return 64;
    }
...
static SECP256K1_INLINE void rustsecp256k1zkp_v0_3_0_memczero(void *s, size_t len, int flag) {
 ...
 */
static SECP256K1_INLINE int rustsecp256k1zkp_v0_3_0_memcmp_var(const void *s1, const void *s2, size_t n) {
...
static SECP256K1_INLINE void rustsecp256k1zkp_v0_3_0_int_cmov(int *r, const int *a, int flag) {
