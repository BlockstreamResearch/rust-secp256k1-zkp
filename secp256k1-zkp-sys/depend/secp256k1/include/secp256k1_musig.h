...
} rustsecp256k1zkp_v0_4_0_musig_keyagg_cache;
...
} rustsecp256k1zkp_v0_4_0_musig_secnonce;
...
} rustsecp256k1zkp_v0_4_0_musig_pubnonce;
...
typedef struct {
    unsigned char data[132];
} rustsecp256k1zkp_v0_4_0_musig_aggnonce;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_pubnonce_parse(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_musig_pubnonce* nonce,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_pubnonce_serialize(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_4_0_musig_pubnonce* nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_aggnonce_parse(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_musig_aggnonce* nonce,
    const unsigned char *in66
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:    nonce: pointer to the nonce
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_aggnonce_serialize(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_4_0_musig_aggnonce* nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_partial_sig_serialize(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    unsigned char *out32,
    const rustsecp256k1zkp_v0_4_0_musig_partial_sig* sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_partial_sig_parse(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_musig_partial_sig* sig,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_pubkey_agg(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    ...
    const rustsecp256k1zkp_v0_4_0_xonly_pubkey * const* pubkeys,
    size_t n_pubkeys
 ...
 *  musig_pubkey_agg and tweak passes `rustsecp256k1zkp_v0_4_0_xonly_pubkey_tweak_test`.
 *
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_nonce_gen(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    ...
    const rustsecp256k1zkp_v0_4_0_musig_keyagg_cache *keyagg_cache,
 ...
 *                       greater than 0.
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_nonce_agg(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_musig_aggnonce  *aggnonce,
    const rustsecp256k1zkp_v0_4_0_musig_pubnonce * const* pubnonces,
    size_t n_pubnonces
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                     signature protocol
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_nonce_process(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_musig_session *session,
    const rustsecp256k1zkp_v0_4_0_musig_aggnonce  *aggnonce,
    const unsigned char *msg32,
    const rustsecp256k1zkp_v0_4_0_musig_keyagg_cache *keyagg_cache,
...
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_partial_sign(
    ...
    rustsecp256k1zkp_v0_4_0_musig_secnonce *secnonce,
    const rustsecp256k1zkp_v0_4_0_keypair *keypair,
    const rustsecp256k1zkp_v0_4_0_musig_keyagg_cache *keyagg_cache,
...
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_musig_partial_sig_verify(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    const rustsecp256k1zkp_v0_4_0_musig_partial_sig *partial_sig,
    const rustsecp256k1zkp_v0_4_0_musig_pubnonce *pubnonce,
...
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_musig_partial_sig_agg(
    ...
    unsigned char *sig64,
    const rustsecp256k1zkp_v0_4_0_musig_session *session,
    const rustsecp256k1zkp_v0_4_0_musig_partial_sig * const* partial_sigs,
    size_t n_sigs
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *                     musig_nonce_process
 */
int rustsecp256k1zkp_v0_4_0_musig_nonce_parity(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    int *nonce_parity,
    rustsecp256k1zkp_v0_4_0_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_musig_adapt(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    unsigned char *sig64,
 ...
 *                     session used for producing sig64
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_musig_extract_adaptor(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
