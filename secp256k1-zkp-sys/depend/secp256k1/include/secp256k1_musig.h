...
} rustsecp256k1zkp_v0_10_1_musig_secnonce;
...
} rustsecp256k1zkp_v0_10_1_musig_session;
...
} rustsecp256k1zkp_v0_10_1_musig_partial_sig;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_pubnonce_parse(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_musig_pubnonce *nonce,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_pubnonce_serialize(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_10_1_musig_pubnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:     in66: pointer to the 66-byte nonce to be parsed
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_aggnonce_parse(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_musig_aggnonce *nonce,
    const unsigned char *in66
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *  In:    nonce: pointer to the nonce
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_aggnonce_serialize(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_10_1_musig_aggnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_partial_sig_serialize(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    unsigned char *out32,
    const rustsecp256k1zkp_v0_10_1_musig_partial_sig *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_partial_sig_parse(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_musig_partial_sig *sig,
 ...
 *
 *  Before aggregating, the pubkeys can be sorted with `rustsecp256k1zkp_v0_10_1_pubkey_sort`
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_pubkey_agg(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    ...
    const rustsecp256k1zkp_v0_10_1_pubkey * const *pubkeys,
    size_t n_pubkeys
 ...
 *                    `musig_pubkey_agg`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_pubkey_get(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_pubkey *agg_pk,
    const rustsecp256k1zkp_v0_10_1_musig_keyagg_cache *keyagg_cache
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *
 *  The tweaking method is the same as `rustsecp256k1zkp_v0_10_1_ec_pubkey_tweak_add`. So after
 *  the following pseudocode buf and buf2 have identical contents (absent
 *  earlier failures).
 *
 *  rustsecp256k1zkp_v0_10_1_musig_pubkey_agg(..., keyagg_cache, pubkeys, ...)
 *  rustsecp256k1zkp_v0_10_1_musig_pubkey_get(..., agg_pk, keyagg_cache)
 *  rustsecp256k1zkp_v0_10_1_musig_pubkey_ec_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  rustsecp256k1zkp_v0_10_1_ec_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1zkp_v0_10_1_ec_pubkey_tweak_add(..., agg_pk, tweak32)
 *  rustsecp256k1zkp_v0_10_1_ec_pubkey_serialize(..., buf2, agg_pk)
 *
 ...
 *                        according to `rustsecp256k1zkp_v0_10_1_ec_seckey_verify`, this function
 *                        returns 0. For uniformly random 32-byte arrays the
 *                        chance of being invalid is negligible (around 1 in
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_pubkey_ec_tweak_add(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_pubkey *output_pubkey,
    rustsecp256k1zkp_v0_10_1_musig_keyagg_cache *keyagg_cache,
 ...
 *  failures) returns 1.
 *
 *  rustsecp256k1zkp_v0_10_1_musig_pubkey_agg(..., agg_pk, keyagg_cache, pubkeys, ...)
 *  rustsecp256k1zkp_v0_10_1_musig_pubkey_xonly_tweak_add(..., output_pk, tweak32, keyagg_cache)
 *  rustsecp256k1zkp_v0_10_1_xonly_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1zkp_v0_10_1_xonly_pubkey_tweak_add_check(..., buf, ..., agg_pk, tweak32)
 *
 *  This function is required if you want to _sign_ for a tweaked aggregate key.
 *  On the other hand, if you are only computing a public key, but not intending
 *  to create a signature for it, you can just use
 ...
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_pubkey_xonly_tweak_add(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_pubkey *output_pubkey,
    rustsecp256k1zkp_v0_10_1_musig_keyagg_cache *keyagg_cache,
    const unsigned char *tweak32
 ...
 *                     call to rustsecp256k1zkp_v0_10_1_musig_nonce_gen and must be uniformly random
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_nonce_gen(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
 ...
 *                       greater than 0.
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_nonce_agg(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_musig_aggnonce  *aggnonce,
    const rustsecp256k1zkp_v0_10_1_musig_pubnonce * const *pubnonces,
    size_t n_pubnonces
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_nonce_process(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_musig_session *session,
    const rustsecp256k1zkp_v0_10_1_musig_aggnonce  *aggnonce,
    const unsigned char *msg32,
    const rustsecp256k1zkp_v0_10_1_musig_keyagg_cache *keyagg_cache,
    const rustsecp256k1zkp_v0_10_1_pubkey *adaptor
 ...
 *  signature with `rustsecp256k1zkp_v0_10_1_musig_partial_sig_verify` to prevent random or
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_partial_sign(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    rustsecp256k1zkp_v0_10_1_musig_partial_sig *partial_sig,
    rustsecp256k1zkp_v0_10_1_musig_secnonce *secnonce,
    const rustsecp256k1zkp_v0_10_1_keypair *keypair,
    const rustsecp256k1zkp_v0_10_1_musig_keyagg_cache *keyagg_cache,
    const rustsecp256k1zkp_v0_10_1_musig_session *session
 ...
 *                    `musig_nonce_process`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_partial_sig_verify(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    const rustsecp256k1zkp_v0_10_1_musig_partial_sig *partial_sig,
    const rustsecp256k1zkp_v0_10_1_musig_pubnonce *pubnonce,
    const rustsecp256k1zkp_v0_10_1_pubkey *pubkey,
    const rustsecp256k1zkp_v0_10_1_musig_keyagg_cache *keyagg_cache,
    const rustsecp256k1zkp_v0_10_1_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5) SECP256K1_ARG_NONNULL(6);
 ...
 *                     greater than 0.
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_partial_sig_agg(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    unsigned char *sig64,
    const rustsecp256k1zkp_v0_10_1_musig_session *session,
    const rustsecp256k1zkp_v0_10_1_musig_partial_sig * const *partial_sigs,
    size_t n_sigs
 ...
 *                     musig_nonce_process
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_musig_nonce_parity(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    int *nonce_parity,
    const rustsecp256k1zkp_v0_10_1_musig_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_adapt(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    unsigned char *sig64,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_1_musig_extract_adaptor(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
