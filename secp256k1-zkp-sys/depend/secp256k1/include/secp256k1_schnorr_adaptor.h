 ...
 *
 *  In addition to the features of rustsecp256k1zkp_v0_10_1_nonce_function_hardened,
 ...
 */
typedef int (*rustsecp256k1zkp_v0_10_1_nonce_function_hardened_schnorr_adaptor)(
 ...
 */
SECP256K1_API const rustsecp256k1zkp_v0_10_1_nonce_function_hardened_schnorr_adaptor rustsecp256k1zkp_v0_10_1_nonce_function_schnorr_adaptor;
 ...
 *                    rustsecp256k1zkp_v0_10_1_nonce_function_schnorr_adaptor is used, then
 *                    aux_rand32 must be a pointer to 32-byte auxiliary randomness
 *                    as per BIP-340.
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_schnorr_adaptor_presign(
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
 ...
 *  To verify it, use `rustsecp256k1zkp_v0_10_1_schnorrsig_verify`.
 *
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_schnorr_adaptor_adapt(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
    unsigned char *sig64,
    const unsigned char *pre_sig65,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_1_schnorr_adaptor_extract_sec(
    const rustsecp256k1zkp_v0_10_1_context *ctx,
