 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_schnorrsig_inc_aggregate(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    unsigned char *aggsig,
    size_t *aggsig_len,
    const rustsecp256k1zkp_v0_11_0_xonly_pubkey* all_pubkeys,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_11_0_schnorrsig_aggregate(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    unsigned char *aggsig,
    size_t *aggsig_len,
    const rustsecp256k1zkp_v0_11_0_xonly_pubkey *pubkeys,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_11_0_schnorrsig_aggverify(
    const rustsecp256k1zkp_v0_11_0_context *ctx,
    const rustsecp256k1zkp_v0_11_0_xonly_pubkey *pubkeys,
    const unsigned char *msgs32,
    size_t n,
