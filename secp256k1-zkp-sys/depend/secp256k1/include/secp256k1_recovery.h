 ...
 *  the rustsecp256k1zkp_v0_10_0_ecdsa_signature_serialize_* and
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature_parse_compact(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature *sig,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature_convert(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_ecdsa_signature *sig,
    const rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature *sigin
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature_serialize_compact(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    unsigned char *output64,
    int *recid,
    const rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature *sig
 ...
 *                      (can be NULL for rustsecp256k1zkp_v0_10_0_nonce_function_default).
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_ecdsa_sign_recoverable(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_ecdsa_recoverable_signature *sig,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_ecdsa_recover(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
