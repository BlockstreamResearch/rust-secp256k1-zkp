...
} rustsecp256k1zkp_v0_4_0_keypair;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_xonly_pubkey_parse(
 ...
 *                 (cannot be NULL).
 *  In:    pubkey: a pointer to a rustsecp256k1zkp_v0_4_0_xonly_pubkey containing an
 *                 initialized public key (cannot be NULL).
 */
SECP256K1_API int rustsecp256k1zkp_v0_4_0_xonly_pubkey_serialize(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_xonly_pubkey_from_pubkey(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_xonly_pubkey *xonly_pubkey,
    int *pk_parity,
 ...
 *  is a normal rustsecp256k1zkp_v0_4_0_pubkey.
 *
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_xonly_pubkey_tweak_add(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
 ...
 *  rustsecp256k1zkp_v0_4_0_xonly_pubkey_tweak_add with internal_pubkey and tweak32.
 *
 *  The tweaked pubkey is represented by its 32-byte x-only serialization and
 *  its pk_parity, which can both be obtained by converting the result of
 *  tweak_add to a rustsecp256k1zkp_v0_4_0_xonly_pubkey.
 *
 ...
 *                        rustsecp256k1zkp_v0_4_0_xonly_pubkey with the tweaked pubkey, or
 *                        this function will fail.
 *       internal_pubkey: pointer to an x-only public key object to apply the
 *                        tweak to (cannot be NULL)
 *               tweak32: pointer to a 32-byte tweak (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_xonly_pubkey_tweak_add_check(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_keypair_create(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_keypair_sec(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
 ...
 *  In: keypair: pointer to a keypair (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_keypair_pub(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
 ...
 *
 *  This is the same as calling rustsecp256k1zkp_v0_4_0_keypair_pub and then
 ...
 *               argument of rustsecp256k1zkp_v0_4_0_xonly_pubkey_from_pubkey (can be NULL).
 *  In: keypair: pointer to a keypair (cannot be NULL)
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_keypair_xonly_pub(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_xonly_pubkey *pubkey,
    int *pk_parity,
    const rustsecp256k1zkp_v0_4_0_keypair *keypair
 ...
 *  key accordingly.
 *
 *  Calling this function and then rustsecp256k1zkp_v0_4_0_keypair_pub results in the same
 *  public key as calling rustsecp256k1zkp_v0_4_0_keypair_xonly_pub and then
 *  rustsecp256k1zkp_v0_4_0_xonly_pubkey_tweak_add.
 *
 ...
 *                   to rustsecp256k1zkp_v0_4_0_ec_seckey_verify, this function returns 0. For
 *                   uniformly random 32-byte arrays the chance of being invalid
 *                   is negligible (around 1 in 2^128) (cannot be NULL).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_4_0_keypair_xonly_tweak_add(
    const rustsecp256k1zkp_v0_4_0_context* ctx,
    rustsecp256k1zkp_v0_4_0_keypair *keypair,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
