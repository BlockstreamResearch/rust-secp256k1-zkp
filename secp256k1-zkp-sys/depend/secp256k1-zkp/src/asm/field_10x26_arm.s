...
*/
	...
	.align	2
	.global secp256k1_zkp_fe_mul_inner
	.type	secp256k1_zkp_fe_mul_inner, %function
	@ Arguments:
...
secp256k1_zkp_fe_mul_inner:
	...
	*/
	...
	.size	secp256k1_zkp_fe_mul_inner, .-secp256k1_zkp_fe_mul_inner

	.align	2
	.global secp256k1_zkp_fe_sqr_inner
	.type	secp256k1_zkp_fe_sqr_inner, %function
	@ Arguments:
...
secp256k1_zkp_fe_sqr_inner:
	...
	*/
	...
	add	sp, sp, #48
	ldmfd	sp!, {r4, r5, r6, r7, r8, r9, r10, r11, pc}
	.size	secp256k1_zkp_fe_sqr_inner, .-secp256k1_zkp_fe_sqr_inner
