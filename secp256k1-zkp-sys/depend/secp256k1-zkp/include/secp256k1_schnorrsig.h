 ...
 *  comparison, use the `secp256k1_zkp_schnorrsig_serialize` and
 *  `secp256k1_zkp_schnorrsig_parse` functions.
 */
typedef struct {
 ...
 *
 *  See secp256k1_zkp_schnorrsig_parse for details about the encoding.
 */
SECP256K1_API int secp256k1_zkp_schnorrsig_serialize(
 ...
 */
SECP256K1_API int secp256k1_zkp_schnorrsig_parse(
    const secp256k1_zkp_context* ctx,
 ...
 *       noncefp: pointer to a nonce generation function. If NULL, secp256k1_zkp_nonce_function_bipschnorr is used
 *         ndata: pointer to arbitrary data used by the nonce generation function (can be NULL)
 */
SECP256K1_API int secp256k1_zkp_schnorrsig_sign(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_schnorrsig *sig,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_schnorrsig_verify(
    const secp256k1_zkp_context* ctx,
    const secp256k1_zkp_schnorrsig *sig,
    const unsigned char *msg32,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_schnorrsig_verify_batch(
    const secp256k1_zkp_context* ctx,
