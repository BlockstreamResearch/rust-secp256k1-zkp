 ...
 *  comparison, use secp256k1_zkp_generator_serialize and secp256k1_zkp_generator_parse.
 */
typedef struct {
    unsigned char data[64];
} secp256k1_zkp_generator;
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_generator_parse(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_generator* gen,
 ...
 */
SECP256K1_API int secp256k1_zkp_generator_serialize(
    const secp256k1_zkp_context* ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_generator_generate(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_generator* gen,
 ...
 *
 *  The result is equivalent to first calling secp256k1_zkp_generator_generate,
 *  converting the result to a public key, calling secp256k1_zkp_ec_pubkey_tweak_add,
 *  and then converting back to generator form.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_generator_generate_blinded(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_generator* gen,
