...
typedef struct {
    ...
    secp256k1_zkp_pubkey combined_nonce;
    int nonce_is_set;
...
} secp256k1_zkp_musig_session_signer_data;
 ...
 */
SECP256K1_API int secp256k1_zkp_musig_session_initialize(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_session *session,
    secp256k1_zkp_musig_session_signer_data *signers,
    unsigned char *nonce_commitment32,
    const unsigned char *session_id32,
    const unsigned char *msg32,
    const secp256k1_zkp_pubkey *combined_pk,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_musig_session_get_public_nonce(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_session *session,
    secp256k1_zkp_musig_session_signer_data *signers,
    secp256k1_zkp_pubkey *nonce,
 ...
 *                    2^32 - 1.
 */
SECP256K1_API int secp256k1_zkp_musig_session_initialize_verifier(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_session *session,
    secp256k1_zkp_musig_session_signer_data *signers,
    const unsigned char *msg32,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_musig_set_nonce(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_session_signer_data *signer,
    const secp256k1_zkp_pubkey *nonce
 ...
 */
SECP256K1_API int secp256k1_zkp_musig_session_combine_nonces(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_session *session,
    const secp256k1_zkp_musig_session_signer_data *signers,
    size_t n_signers,
    int *nonce_is_negated,
    const secp256k1_zkp_pubkey *adaptor
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_musig_session_set_msg(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_session *session,
    const unsigned char *msg32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int secp256k1_zkp_musig_partial_signature_serialize(
    const secp256k1_zkp_context* ctx,
    unsigned char *out32,
    const secp256k1_zkp_musig_partial_signature* sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int secp256k1_zkp_musig_partial_signature_parse(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_partial_signature* sig,
 ...
 */
SECP256K1_API int secp256k1_zkp_musig_partial_sign(
    const secp256k1_zkp_context* ctx,
    const secp256k1_zkp_musig_session *session,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_musig_partial_sig_verify(
    const secp256k1_zkp_context* ctx,
    const secp256k1_zkp_musig_session *session,
    const secp256k1_zkp_musig_session_signer_data *signer,
    const secp256k1_zkp_musig_partial_signature *partial_sig,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_musig_partial_sig_combine(
    const secp256k1_zkp_context* ctx,
    const secp256k1_zkp_musig_session *session,
    secp256k1_zkp_schnorrsig *sig,
    const secp256k1_zkp_musig_partial_signature *partial_sigs,
    size_t n_sigs
 ...
 */
SECP256K1_API int secp256k1_zkp_musig_partial_sig_adapt(
    const secp256k1_zkp_context* ctx,
    secp256k1_zkp_musig_partial_signature *adaptor_sig,
    const secp256k1_zkp_musig_partial_signature *partial_sig,
 ...
 *   nonce_is_negated: the `nonce_is_negated` output of `musig_session_combine_nonces`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int secp256k1_zkp_musig_extract_secret_adaptor(
    const secp256k1_zkp_context* ctx,
    unsigned char *sec_adaptor32,
    const secp256k1_zkp_schnorrsig *sig,
    const secp256k1_zkp_musig_partial_signature *partial_sigs,
