...
extern "C" {
    #[cfg_attr(not(rust_secp_zkp_no_symbol_renaming), link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recoverable_signature_parse_compact")]
    ...
    #[cfg_attr(not(rust_secp_zkp_no_symbol_renaming), link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recoverable_signature_serialize_compact")]
    pub fn secp256k1_ecdsa_recoverable_signature_serialize_compact(cx: *const Context, output64: *mut c_uchar,
                                                                   recid: *mut c_int, sig: *const RecoverableSignature)
                                                                   -> c_int;

    #[cfg_attr(not(rust_secp_zkp_no_symbol_renaming), link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recoverable_signature_convert")]
...
#[cfg(not(secp256k1_fuzz))]
extern "C" {
    #[cfg_attr(not(rust_secp_zkp_no_symbol_renaming), link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_sign_recoverable")]
    ...
    #[cfg_attr(not(rust_secp_zkp_no_symbol_renaming), link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recover")]
