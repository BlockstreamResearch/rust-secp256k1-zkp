...
extern "C" {
    #[cfg_attr(
        ...
        link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recoverable_signature_parse_compact"
    )]
    ...
    #[cfg_attr(
        not(rust_secp_zkp_no_symbol_renaming),
        link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recoverable_signature_serialize_compact"
    )]
    ...
    #[cfg_attr(
        not(rust_secp_zkp_no_symbol_renaming),
        link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recoverable_signature_convert"
    )]
...
extern "C" {
    #[cfg_attr(
        not(rust_secp_zkp_no_symbol_renaming),
        link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_sign_recoverable"
    )]
    ...
    #[cfg_attr(
        not(rust_secp_zkp_no_symbol_renaming),
        link_name = "rustsecp256k1zkp_v0_11_0_ecdsa_recover"
    )]
