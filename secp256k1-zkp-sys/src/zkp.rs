...
extern "C" {
    #[cfg_attr(
        ...
        link_name = "rustsecp256k1zkp_v0_7_0_pedersen_commitment_parse"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_pedersen_commitment_serialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_pedersen_commit"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_pedersen_blind_generator_blind_sum"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_pedersen_verify_tally"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_rangeproof_info"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_rangeproof_rewind"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_rangeproof_verify"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_rangeproof_sign"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_surjectionproof_initialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_surjectionproof_serialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_surjectionproof_serialized_size"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_surjectionproof_parse"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_surjectionproof_generate"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_surjectionproof_verify"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_generator_generate_blinded"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_generator_serialize"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_generator_parse"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_nonce_function_ecdsa_adaptor"
    )]
    pub static secp256k1_nonce_function_ecdsa_adaptor: EcdsaAdaptorNonceFn;

    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_ecdsa_adaptor_encrypt"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_ecdsa_adaptor_verify"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_ecdsa_adaptor_decrypt"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_ecdsa_adaptor_recover"
    )]
    ...
    #[cfg_attr(
        not(feature = "external-symbols"),
        link_name = "rustsecp256k1zkp_v0_7_0_whitelist_signature_parse"
    )]
